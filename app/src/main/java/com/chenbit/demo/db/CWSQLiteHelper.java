 ...
 * 数据库、表的创建、更新
 */
public class CWSQLiteHelper extends SQLiteOpenHelper {
    private static final String TAG = CWSQLiteHelper.class.getSimpleName();
    ...
    public CWSQLiteHelper(Context context) {
